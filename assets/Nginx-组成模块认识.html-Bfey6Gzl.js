import{_ as e}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as n,o as i,b as s}from"./app-ozOjtUNl.js";const t={},l=s(`<p>前面已经安装好了Nginx,并知道如何将vue项目代码上传到指定路径实现静态服务器，如何通过proxy实现后端接口的反向代理。本文我们将了解在Nginx中的一些高级特性，从而更加理解它的原理</p><h2 id="ngx-http-ssl-module" tabindex="-1"><a class="header-anchor" href="#ngx-http-ssl-module"><span>ngx_http_ssl_module</span></a></h2><p>通过<code>--with-http_ssl_module</code>可以编译 ssl模块，它依赖于 <code>OpenSSL</code></p><p>在安装nginx之后我们已经介绍了如果需要开启ssl，我们需要对配置做下面的修改</p><div class="language-conf line-numbers-mode" data-ext="conf" data-title="conf"><pre class="language-conf"><code>worker_processes auto;
http {
